...
addMapping([0, 1], ['/backgrounds/sun/sun.jpg', '/backgrounds/sun/sun-2.jpg']);
addMapping(
	[2],
	[
...
addMapping([71, 73, 75, 77, 85, 86], ['/backgrounds/snow/snow.jpg']);
addMapping(
	[95, 96, 99],
	[
...
addMapping([100, 101], ['/backgrounds/moon/moon.jpg']);
addMapping([200], ['/backgrounds/cloud-moon/cloud-moon.jpg']);
